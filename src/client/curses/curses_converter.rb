require "client/curses/curses_ui_character"
require "client/curses/curses_ui_text"
require "client/curses/curses_ui_rect"
require "client/curses/curses_ui_dialog"
